                    ...
                    {({ formState }) => (
                        <>
                            <Text
                                ...
                                validateOnChange
                            />
                            <label htmlFor="goodName" className={style.messageError}>{formState.errors.goodName}</label>
                            ...
                            <TextArea
                                ...
                                validateOnChange
                            />
                            <label htmlFor="description" className={style.messageError}>{formState.errors.description}</label>
                            ...
                            <Text
                                ...
                                validateOnChange
                            />
                            <label htmlFor="price" className={style.messageError}>{formState.errors.price}</label>
                            ...
                            <Button className={classNames("button-basic", style.buttonUpdate)} onClick={() => this.onSubmit(formState)} >Update good</Button>
                            <Button type="button" styleType="small" onClick={this.onClose} className={style.buttonClose}>
                                <MdCancel/>
                            </Button>
                        </>
                    )}
